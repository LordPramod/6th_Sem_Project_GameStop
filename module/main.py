...
# Ensure the description column exist checking and fill NaN values if any
...
# function for recommendations based on description
...
def recommend():
    #  title from either POST and GET request
