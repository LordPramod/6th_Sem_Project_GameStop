...
if (isset($_SESSION['name'])) {
    ...
    if (isset($_POST['addCart'])) {
        ...
        $response = mysqli_query($connect, "Insert INTO pdt_cart (user_id , product_name , product_price , product_quantity , total_amount) VALUES 
        ('$user_id','$product_name','$product_price','$product_quantity','$total')");
